...
export class HomeComponent {
  ...
  gorev = [
    ...
    },
    {
      id: 2,
      parentId: 1,
      title: 'arazi işlerini yap',
      start: new Date('2021-01-01'),
      end: new Date('2021-01-16'),
      progress: 100,
      before: ''
    },
    {
  ...
  constructor() {
    setInterval(() => {
      //console.log(this.demoV);
    }, 1000)
  }

  post(data: any, value: any, area: any) {
    if (data[area] != value && value != undefined) {
